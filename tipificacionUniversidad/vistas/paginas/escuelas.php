                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#nuevaEscuela">
                                Nueva escuela
                            </button>
                        </div>
                        <div class="card-body">
...
<div class="modal fade" id="nuevaEscuela" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action="" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-4">
                        ...
                        <input type="text" class="form-control" name="registroEscuela" placeholder="Ingresa el nombre de la escuela" required>
