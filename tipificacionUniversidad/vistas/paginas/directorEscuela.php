...
<div class="content-wrapper" style="min-height: 1761.5px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Gestor de director de escuela</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#crearDirector">
                                Nuevo director
                            </button>
                        </div>
                        <div class="card-body">
...
<div class="modal fade" id="crearDirector" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="" method="POST">
                <div class="modal-header bg-secondary">
                    <h5 class="modal-title" id="staticBackdropLabel">Crear director</h5>
