                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#nuevaCategoria">
                                Nueva categoria
                            </button>
                        </div>
                        <div class="card-body">
...
<div class="modal fade" id="nuevaCategoria" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action="" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-4">
                        ...
                        <input type="text" class="form-control" name="registroRol" placeholder="Ingrese nombre de la categoria" required>
